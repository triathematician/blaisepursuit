...
public abstract class SimComponent {
    ...
    /** Constructs component with a given parent. Also adds the component to the parent if it is not already there. */
    public SimComponent() {
    }
    ...
    public SimComposite getParent() {
        return parent;
    }

    public void setParent(SimComposite parent) {
