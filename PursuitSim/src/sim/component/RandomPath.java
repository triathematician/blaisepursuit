 ...
 */
public class RandomPath extends SimComponent
    ...
    /**
     * @param angleChange the maximum change in angle per unit time
     * @param speed the top speed, i.e. maximum distance traveled
     */
    public RandomPath(double angleChange, double speed) {
        this.maxAngleChange = angleChange;
        this.topSpeed = speed;
    }
