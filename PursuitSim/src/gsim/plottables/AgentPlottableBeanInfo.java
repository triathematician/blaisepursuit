 ...
 * @author ae3263
 */
public class AgentPlottableBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( gsim.plottables.AgentPlottable.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_adjusting] = new PropertyDescriptor ( "adjusting", gsim.plottables.AgentPlottable.class, "isAdjusting", null ); // NOI18N
            properties[PROPERTY_adjusting].setHidden ( true );
            properties[PROPERTY_animationOn] = new PropertyDescriptor ( "animationOn", gsim.plottables.AgentPlottable.class, "isAnimationOn", "setAnimationOn" ); // NOI18N
            properties[PROPERTY_animationOn].setExpert ( true );
            properties[PROPERTY_color] = new PropertyDescriptor ( "color", gsim.plottables.AgentPlottable.class, "getColor", "setColor" ); // NOI18N
            properties[PROPERTY_color].setPreferred ( true );
            properties[PROPERTY_editable] = new PropertyDescriptor ( "editable", gsim.plottables.AgentPlottable.class, "isEditable", "setEditable" ); // NOI18N
            properties[PROPERTY_editable].setExpert ( true );
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", gsim.plottables.AgentPlottable.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_name].setHidden ( true );
            properties[PROPERTY_plottableArray] = new IndexedPropertyDescriptor ( "plottableArray", gsim.plottables.AgentPlottable.class, "getPlottableArray", "setPlottableArray", "getPlottableArray", "setPlottableArray" ); // NOI18N
            properties[PROPERTY_plottableArray].setPreferred ( true );
            properties[PROPERTY_plottables] = new PropertyDescriptor ( "plottables", gsim.plottables.AgentPlottable.class, "getPlottables", null ); // NOI18N
            properties[PROPERTY_plottables].setHidden ( true );
            properties[PROPERTY_pointStyle] = new PropertyDescriptor ( "pointStyle", gsim.plottables.AgentPlottable.class, "getPointStyle", "setPointStyle" ); // NOI18N
            properties[PROPERTY_pointStyle].setPreferred ( true );
            properties[PROPERTY_selected] = new PropertyDescriptor ( "selected", gsim.plottables.AgentPlottable.class, "isSelected", "setSelected" ); // NOI18N
            properties[PROPERTY_selected].setHidden ( true );
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", gsim.plottables.AgentPlottable.class, "isVisible", "setVisible" ); // NOI18N
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_changeListener] = new EventSetDescriptor ( gsim.plottables.AgentPlottable.class, "changeListener", javax.swing.event.ChangeListener.class, new String[] {"stateChanged"}, "addChangeListener", "removeChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_updatePath16 = 16;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_stateChanged14] = new MethodDescriptor(gsim.plottables.AgentPlottable.class.getMethod("stateChanged", new Class[] {javax.swing.event.ChangeEvent.class})); // NOI18N
            ...
            methods[METHOD_updatePath16] = new MethodDescriptor(gsim.plottables.AgentPlottable.class.getMethod("updatePath", new Class[] {})); // NOI18N
            methods[METHOD_updatePath16].setDisplayName ( "" );
