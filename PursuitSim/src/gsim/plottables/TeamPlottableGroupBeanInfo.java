 ...
 * @author ae3263
 */
public class TeamPlottableGroupBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( gsim.plottables.TeamPlottableGroup.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_baseColor = 2;
    ...
    private static final int PROPERTY_pointStyle = 7;
    private static final int PROPERTY_selected = 8;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_adjusting] = new PropertyDescriptor ( "adjusting", gsim.plottables.TeamPlottableGroup.class, "isAdjusting", null ); // NOI18N
            properties[PROPERTY_adjusting].setHidden ( true );
            properties[PROPERTY_animationOn] = new PropertyDescriptor ( "animationOn", gsim.plottables.TeamPlottableGroup.class, "isAnimationOn", "setAnimationOn" ); // NOI18N
            properties[PROPERTY_animationOn].setExpert ( true );
            properties[PROPERTY_baseColor] = new PropertyDescriptor ( "baseColor", gsim.plottables.TeamPlottableGroup.class, "getBaseColor", "setBaseColor" ); // NOI18N
            properties[PROPERTY_baseColor].setPreferred ( true );
            properties[PROPERTY_editable] = new PropertyDescriptor ( "editable", gsim.plottables.TeamPlottableGroup.class, "isEditable", "setEditable" ); // NOI18N
            properties[PROPERTY_editable].setExpert ( true );
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", gsim.plottables.TeamPlottableGroup.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_name].setHidden ( true );
            properties[PROPERTY_plottableArray] = new IndexedPropertyDescriptor ( "plottableArray", gsim.plottables.TeamPlottableGroup.class, "getPlottableArray", "setPlottableArray", "getPlottableArray", "setPlottableArray" ); // NOI18N
            properties[PROPERTY_plottableArray].setPreferred ( true );
            properties[PROPERTY_plottables] = new PropertyDescriptor ( "plottables", gsim.plottables.TeamPlottableGroup.class, "getPlottables", null ); // NOI18N
            properties[PROPERTY_plottables].setHidden ( true );
            properties[PROPERTY_pointStyle] = new PropertyDescriptor ( "pointStyle", gsim.plottables.TeamPlottableGroup.class, "getPointStyle", "setPointStyle" ); // NOI18N
            properties[PROPERTY_pointStyle].setPreferred ( true );
            properties[PROPERTY_selected] = new PropertyDescriptor ( "selected", gsim.plottables.TeamPlottableGroup.class, "isSelected", "setSelected" ); // NOI18N
            properties[PROPERTY_selected].setHidden ( true );
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", gsim.plottables.TeamPlottableGroup.class, "isVisible", "setVisible" ); // NOI18N
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_changeListener] = new EventSetDescriptor ( gsim.plottables.TeamPlottableGroup.class, "changeListener", javax.swing.event.ChangeListener.class, new String[] {"stateChanged"}, "addChangeListener", "removeChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_updatePaths16 = 16;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_draw3] = new MethodDescriptor(org.bm.blaise.specto.visometry.PlottableGroup.class.getMethod("draw", new Class[] {org.bm.blaise.specto.visometry.VisometryGraphics.class})); // NOI18N
            ...
            methods[METHOD_stateChanged14] = new MethodDescriptor(gsim.plottables.TeamPlottableGroup.class.getMethod("stateChanged", new Class[] {javax.swing.event.ChangeEvent.class})); // NOI18N
            methods[METHOD_stateChanged14].setDisplayName ( "" );
            methods[METHOD_toString15] = new MethodDescriptor(org.bm.blaise.specto.visometry.PlottableGroup.class.getMethod("toString", new Class[] {})); // NOI18N
            methods[METHOD_toString15].setDisplayName ( "" );
            methods[METHOD_updatePaths16] = new MethodDescriptor(gsim.plottables.TeamPlottableGroup.class.getMethod("updatePaths", new Class[] {})); // NOI18N
            methods[METHOD_updatePaths16].setDisplayName ( "" );
